...
<form class="row row-cols-lg-auto g-3 mb-3 align-items-center needs-validation" method="POST" action="/admin" enctype="multipart/form-data" novalidate>
    ...
    <div class="col-12 position-relative">
        ...
        <div class="invalid-tooltip">Please select a adults prayer calendar CSV file generated by Church Suite.</div>
    </div>
    <div class="col-12">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5>Step Two</h5>
                <?php $rota_export_link = "https://ccsp.churchsuite.com/modules/rotas/reports/rotas_overview.php?_module=ChurchSuite%5CRotas&_report_name=rotas_overview&_report_view_module=rotas&_report_view_file=rotas_overview&date_start=&date_end=&order_by=name&group_by=service&break_page_on_section=off&show_empty_dates=off&show_members_table=off&page=1"; ?>
                <p>Click <a href="<?php echo $rota_export_link; ?>" target="_blank">here</a> to open the Rota export page.</p>
                <h5>Step Three</h5>
