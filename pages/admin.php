...
<form class="row row-cols-lg-auto g-3 align-items-center needs-validation" method="POST" enctype="multipart/form-data" novalidate>
    <div class="col-12">
        ...
        <div class="invalid-feedback">Please enter the rota name.</div>
    </div>
    <div class="col-12">
        <label class="visually-hidden" for="file">Rota File</label>
        <input class="form-control" type="file" id="file" name="file" required />
        <div class="invalid-feedback">Please select a rota CSV file generated by Church Suite.</div>
    </div>
    <div class="col-12">
...
<div class="modal fade" id="csv-instructions" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Generating Rota CSV File</h5>
            ...
            <div class="modal-body">
                ...
                <h5>Step Two</h5>
                <?php $csv_export_link = "https://ccsp.churchsuite.com/modules/rotas/reports/rotas_overview.php?_module=ChurchSuite%5CRotas&_report_name=rotas_overview&_report_view_module=rotas&_report_view_file=rotas_overview&date_start=2022-08-20&date_end=2022-08-27&order_by=name&group_by=service&break_page_on_section=off&show_empty_dates=off&show_members_table=off&page=1"; ?>
