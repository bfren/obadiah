...
<p>Today&rsquo;s entry on the Refresh calendar.  <a href="/refresh/help">Click here</a> for help and further information.</p>
...
<div class="row">
    ...
    <div class="col-12 col-md-4">
        ...
        <?php if ($model->today->readings) : $readings = $model->today->readings; ?>
            <p><em>Click on a passage to view the text on Bible Gateway, using the <?php _e(C::$rota->bible_version) ?> translation.</em></p>
            <p>1: <?php $this->part("reading", model: sprintf("Psalms %s", $readings->ot_psalms)); ?></p>
            <p>2: <?php $this->part("reading", model: $readings->ot_1); ?></p>
            <p>3: <?php $this->part("reading", model: $readings->ot_2); ?></p>
            <p>4: <?php $this->part("reading", model: $readings->nt_gospels); ?></p>
            <p>5: <?php $this->part("reading", model: $readings->nt_epistles); ?></p>
        <?php else : ?>
    ...
    <div class="col-12 col-md-4">
        ...
        <?php if ($model->today->people) : ?>
            <p><em><?php _h(C::$refresh->footer_page_1_left); ?> <?php _h(C::$refresh->footer_page_1_right); ?></em></p>
    ...
    <div class="col-12 col-md-4">
        ...
        <p><em>These are set prayers used by the Church of England to gather (or &lsquo;collect&rsquo;) people and prayers together.  Normally they reflect the church year or a particular saint.</em></p>
        <?php _h(str_replace("\n", "<br />", $collect)); ?>
    </div>
    <?php endif; ?>
