...
abstract class Action
{
    ...
    protected function __construct(
        ...
        $this->add_header("Content-Security-Policy", "default-src 'self'; script-src 'self'; style-src 'self' https://static.bcg.xyz; img-src 'self' data: https:; font-src 'self' https://static.bcg.xyz/; connect-src 'self'; frame-ancestors 'none'");
